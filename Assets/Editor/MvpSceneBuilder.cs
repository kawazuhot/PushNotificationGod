...
public static class MvpSceneBuilder
{
    ...
    private static void CreateGameScene(GameObject cardPrefab)
    {
        ...
        Text combo = CreateText("ComboText", safe.transform, "", 72, FontStyle.Bold, TextAnchor.MiddleCenter, Color.white);
        combo.raycastTarget = false;
        combo.supportRichText = true;
        combo.horizontalOverflow = HorizontalWrapMode.Overflow;
        combo.verticalOverflow = VerticalWrapMode.Overflow;
        combo.rectTransform.anchorMin = new Vector2(0.5f, 0f);
        combo.rectTransform.anchorMax = new Vector2(0.5f, 0f);
        combo.rectTransform.pivot = new Vector2(0.5f, 0.5f);
        combo.rectTransform.anchoredPosition = new Vector2(0f, 360f);
        combo.rectTransform.sizeDelta = new Vector2(880f, 180f);
        combo.gameObject.AddComponent<CanvasGroup>().alpha = 0f;
        combo.gameObject.AddComponent<Shadow>().effectDistance = new Vector2(0f, -5f);
        combo.gameObject.AddComponent<Outline>().effectDistance = new Vector2(3f, -3f);
        ...
        SetSerializedFloat(gameManager, "countdownStepDuration", 1f);
        SetSerializedFloat(gameManager, "countdownStartDuration", 0.8f);
    ...
    private static void CreateResultScene()
    {
        ...
        resultPanel.rectTransform.sizeDelta = new Vector2(850f, 1460f);
        ...
        Button retry = CreateButton("RetryButton", safe.transform, "もう一度", new Vector2(-188f, 548f), new Vector2(340f, 82f));
        UnityEventTools.AddPersistentListener(retry.onClick, result.OnRetryButton);
        Button title = CreateButton("BackToTitleButton", safe.transform, "タイトルへ", new Vector2(188f, 548f), new Vector2(340f, 82f));
        ...
        SetCenter(heading.rectTransform, new Vector2(0f, 448f), new Vector2(760f, 92f));
        Text playerName = CreateText("PlayerNameText", safe.transform, "ななしの通知人", 52, FontStyle.Bold, TextAnchor.MiddleCenter, new Color(0.04f, 0.08f, 0.12f, 0.95f));
        SetCenter(playerName.rectTransform, new Vector2(0f, 364f), new Vector2(800f, 76f));
        ScoreColorUtility.ApplyReadableEffects(playerName);
        ...
        SetCenter(rankTitleLabel.rectTransform, new Vector2(0f, 270f), new Vector2(740f, 46f));
        CreateResultValueBackground(safe.transform, "RankTitleValueBackground", new Vector2(0f, 180f), new Vector2(720f, 140f));
        Text rankTitle = CreateText("RankTitleText", safe.transform, "通知に飲まれた人", 48, FontStyle.Bold, TextAnchor.MiddleCenter, Color.white);
        SetCenter(rankTitle.rectTransform, new Vector2(0f, 210f), new Vector2(760f, 70f));
        ...
        SetCenter(rankDescription.rectTransform, new Vector2(0f, 142f), new Vector2(740f, 56f));
        ...
        SetCenter(finalScoreLabel.rectTransform, new Vector2(0f, 48f), new Vector2(740f, 50f));
        CreateResultValueBackground(safe.transform, "FinalScoreValueBackground", new Vector2(0f, -30f), new Vector2(650f, 116f));
        Text finalScore = CreateText("FinalScoreText", safe.transform, "0", 92, FontStyle.Bold, TextAnchor.MiddleCenter, Color.white);
        SetCenter(finalScore.rectTransform, new Vector2(0f, -30f), new Vector2(760f, 94f));
        ScoreColorUtility.ApplyScoreVisual(finalScore, 0);
        ...
        SetCenter(maxComboLabel.rectTransform, new Vector2(0f, -326f), new Vector2(740f, 46f));
        CreateResultValueBackground(safe.transform, "MaxComboValueBackground", new Vector2(0f, -388f), new Vector2(670f, 98f));
        Text maxCombo = CreateText("MaxComboText", safe.transform, "0 COMBO", 72, FontStyle.Bold, TextAnchor.MiddleCenter, Color.white);
        SetCenter(maxCombo.rectTransform, new Vector2(0f, -388f), new Vector2(760f, 80f));
        ScoreColorUtility.ApplyComboVisual(maxCombo, 0);

        SetSerialized(result, "finalScoreText", finalScore);
        SetSerialized(result, "maxComboText", maxCombo);
        SetSerialized(result, "playerNameText", playerName);
    ...
    private static void ConfigureAudioManager(AudioManager audioManager, AudioSource audioSource, AudioSource bgmAudioSource = null)
    {
        ...
        SetSerialized(audioManager, "combo30Se", LoadSeClip("se_combo_30.mp3"));
        ...
        SetSerialized(audioManager, "countdownTickClipOverride", LoadSeClip("se_countdown_tick.mp3"));
        SetSerialized(audioManager, "countdownStartClipOverride", LoadSeClip("se_countdown_start.mp3"));
        SetSerialized(audioManager, "gameplayBgmClipOverride", LoadBgmClip("bgm_gameplay.mp3"));
