...
public static class MvpSceneBuilder
{
    ...
    private static void CreateResultScene()
    {
        ...
        SetCenter(finalScoreLabel.rectTransform, new Vector2(0f, 104f), new Vector2(740f, 50f));
        CreateResultValueBackground(safe.transform, "FinalScoreValueBackground", new Vector2(0f, 26f), new Vector2(650f, 116f));
        Text finalScore = CreateText("FinalScoreText", safe.transform, "0", 92, FontStyle.Bold, TextAnchor.MiddleCenter, Color.white);
        SetCenter(finalScore.rectTransform, new Vector2(0f, 26f), new Vector2(760f, 94f));
        ...
        SetCenter(maxComboLabel.rectTransform, new Vector2(0f, -278f), new Vector2(740f, 46f));
        CreateResultValueBackground(safe.transform, "MaxComboValueBackground", new Vector2(0f, -340f), new Vector2(670f, 98f));
        Text maxCombo = CreateText("MaxComboText", safe.transform, "0 COMBO", 72, FontStyle.Bold, TextAnchor.MiddleCenter, Color.white);
        SetCenter(maxCombo.rectTransform, new Vector2(0f, -340f), new Vector2(760f, 80f));
